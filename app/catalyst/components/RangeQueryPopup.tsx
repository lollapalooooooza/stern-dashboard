...
export default function RangeQueryPopup({ range, chartRect, onAsk, onClose, portalTarget }: Props) {
  ...
  const popup = (
    ...
    >
      ...
      <div className="range-popup-label">Ask CatalystTracker</div>
  ...
  return createPortal(popup, portalTarget || document.body);
}
